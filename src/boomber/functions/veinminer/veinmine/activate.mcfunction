execute if score $ore_kind bb.vm.var matches 1 run function boomber:veinminer/veinmine/spread/coal_ore
execute if score $ore_kind bb.vm.var matches 2 run function boomber:veinminer/veinmine/spread/lapis_ore
execute if score $ore_kind bb.vm.var matches 3 run function boomber:veinminer/veinmine/spread/iron_ore
execute if score $ore_kind bb.vm.var matches 4 run function boomber:veinminer/veinmine/spread/gold_ore
