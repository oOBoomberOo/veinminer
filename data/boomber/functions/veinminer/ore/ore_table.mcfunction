execute if entity @s[nbt={Item: {id: 'minecraft:coal'}}] run scoreboard players set #bb.vm.mining_state bb.vm.success 1
execute if entity @s[nbt={Item: {id: 'minecraft:coal_ore'}}] run scoreboard players set #bb.vm.mining_state bb.vm.success 1

execute if entity @s[nbt={Item: {id: 'minecraft:lapis_lazuli'}}] run scoreboard players set #bb.vm.mining_state bb.vm.success 2
...
execute if entity @s[nbt={Item: {id: 'minecraft:diamond'}}] run scoreboard players set #bb.vm.mining_state bb.vm.success 6
execute if entity @s[nbt={Item: {id: 'minecraft:diamond_ore'}}] run scoreboard players set #bb.vm.mining_state bb.vm.success 6

execute if entity @s[nbt={Item: {id: 'minecraft:emerald'}}] run scoreboard players set #bb.vm.mining_state bb.vm.success 7
execute if entity @s[nbt={Item: {id: 'minecraft:emerald_ore'}}] run scoreboard players set #bb.vm.mining_state bb.vm.success 7
